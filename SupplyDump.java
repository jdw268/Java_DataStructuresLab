...
//      }
  ...
  * Input: None
  * Return: Void
  * Description: Requests user to input order number and calls buildOrder to start building each order.
    ...
    try{
      ...
      //since user entered valid parts, call requestParts(check stock in this method)
        ...
        try{
          ...
          ArrayList<Part> partsRequested = requestParts(oid);          
      ...
      for (String j : stock) {
        ...
        for (int t = 0; t < n.getLength(); t++) {
          ...
          switch (j) {
            ...
            Body initialB = new Body(j, "0", 0.0, "0");
            ...
            for (int i = 0; i < Integer.parseInt(e.getElementsByTagName("qty").item(0).getTextContent()); i++) {
              ...
              Body b = new Body(j, e.getAttribute("id"), Double.parseDouble(e.getElementsByTagName("Cost").item(0).getTextContent()), e.getElementsByTagName("name").item(0).getTextContent());
            ...
            case "Exterior":
            Exterior initialE = new Exterior(j, "0", 0.0, "0");
            ...
            for (int i = 0; i < Integer.parseInt(e.getElementsByTagName("qty").item(0).getTextContent()); i++) {
              ...
              Exterior ext = new Exterior(j, e.getAttribute("id"), Double.parseDouble(e.getElementsByTagName("Cost").item(0).getTextContent()), e.getElementsByTagName("color").item(0).getTextContent());
            ...
            case "Interior":
            Interior initialI = new Interior(j, "0", 0.0, "0", "0");
            ...
            for (int i = 0; i < Integer.parseInt(e.getElementsByTagName("qty").item(0).getTextContent()); i++) {
              ...
              Interior interiorPart = new Interior(j, e.getAttribute("id"), Double.parseDouble(e.getElementsByTagName("Cost").item(0).getTextContent()), e.getElementsByTagName("color").item(0).getTextContent(), e.getElementsByTagName("material").item(0).getTextContent());
            ...
            case "Powertrain":
            Powertrain initialP = new Powertrain(j, "0", 0.0, false);
            tempParts.add(initialP);
            for (int i = 0; i < Integer.parseInt(e.getElementsByTagName("qty").item(0).getTextContent()); i++) {
              Powertrain p;
              p = new Powertrain(j, e.getAttribute("id"), Double.parseDouble(e.getElementsByTagName("Cost").item(0).getTextContent()), Boolean.parseBoolean(e.getElementsByTagName("auto").item(0).getTextContent()));
              tempParts.add(p);
            ...
            case "Seat":
            Seat initialS = new Seat(j, "0", 0.0, "0");
            tempParts.add(initialS);
            for (int i = 0; i < Integer.parseInt(e.getElementsByTagName("qty").item(0).getTextContent()); i++) {
              Seat s;
              s = new Seat(j, e.getAttribute("id"), Double.parseDouble(e.getElementsByTagName("Cost").item(0).getTextContent()), e.getElementsByTagName("sType").item(0).getTextContent());
              tempParts.add(s);
              Stock.put("Seat" + s.getId(), tempParts);
            }
            break;
            case "Radio":
            Radio initialR = new Radio(j, "0", 0.0, "0");
            tempParts.add(initialR);
            for (int i = 0; i < Integer.parseInt(e.getElementsByTagName("qty").item(0).getTextContent()); i++) {
              Radio r;
              r = new Radio(j, e.getAttribute("id"), Double.parseDouble(e.getElementsByTagName("Cost").item(0).getTextContent()), e.getElementsByTagName("console").item(0).getTextContent());
              tempParts.add(r);
              Stock.put("Radio" + r.getId(), tempParts);
            }
            break;
            case "Rim":
            Rim initialRim = new Rim(j, "0", 0.0, 0);
            tempParts.add(initialRim);
            for (int i = 0; i < Integer.parseInt(e.getElementsByTagName("qty").item(0).getTextContent()); i++) {
              Rim rims;
              rims = new Rim(j, e.getAttribute("id"), Double.parseDouble(e.getElementsByTagName("Cost").item(0).getTextContent()), Integer.parseInt(e.getElementsByTagName("size").item(0).getTextContent()));
              tempParts.add(rims);
              Stock.put("Rim" + rims.getId(), tempParts);
            }
            break;
            case "Tire":
            Tire initialT = new Tire(j, "0", 0.0, "0");
            tempParts.add(initialT);
            for (int i = 0; i < Integer.parseInt(e.getElementsByTagName("qty").item(0).getTextContent()); i++) {
              Tire tires;
              tires = new Tire(j, e.getAttribute("id"), Double.parseDouble(e.getElementsByTagName("Cost").item(0).getTextContent()), e.getElementsByTagName("tType").item(0).getTextContent());
              tempParts.add(tires);
            ...
            case "Misc":            
            Misc initialM = new Misc(j, "initial", 0.0, 0);
            ...
            switch (t){
                case 0:  // driving assist misc option indexed at 0
                    ...
                    for (int y = 0; y<nList.getLength(); y++){
                        ...
                        Misc initialD = new DrivingAssist("DrivingAssist", "0", 0.0, 0, "0");
                        p.add(initialD);
                        ...
                        for (int z = 0; z <Integer.parseInt(temp.getElementsByTagName("qty").item(0).getTextContent()); z++){
                            ...
                            misc = new DrivingAssist("DrivingAssist", temp.getAttribute("id"), Double.parseDouble(temp.getElementsByTagName("Cost").item(0).getTextContent()), Integer.parseInt(e.getAttribute("index")), temp.getElementsByTagName("dType").item(0).getTextContent());
                ...
                case 1:   //roof -  misc option indexed a 1                   
                    ...
                    for (int y = 0; y<mList.getLength(); y++){
                        ...
                        Element temp = (Element) node;
                        ArrayList<Part> p = new ArrayList<Part>();
                        Misc initialR = new Roof("Roof", "0", 0.0, 0, "0");
                        p.add(initialR);
                        for (int z = 0; z <Integer.parseInt(temp.getElementsByTagName("qty").item(0).getTextContent()); z++){
                         misc = new Roof("Roof", temp.getAttribute("id"), Double.parseDouble(temp.getElementsByTagName("Cost").item(0).getTextContent()), Integer.parseInt(e.getAttribute("index")), temp.getElementsByTagName("rType").item(0).getTextContent());
                            p.add(misc);
                ...
                case 2:  //Backup - misc option indexed at 2 
                    ...
                    for (int y = 0; y<bList.getLength(); y++){
                        ...
                        Element temp = (Element) node;
                        ArrayList<Part> p = new ArrayList<Part>();
                        Misc initialB = new Backup("Backup", "0", 0.0, 0, "0");
                        p.add(initialB);
                        for (int z = 0; z <Integer.parseInt(temp.getElementsByTagName("qty").item(0).getTextContent()); z++){
                         misc = new Backup("Backup", temp.getAttribute("id"), Double.parseDouble(temp.getElementsByTagName("Cost").item(0).getTextContent()), Integer.parseInt(e.getAttribute("index")), temp.getElementsByTagName("bType").item(0).getTextContent());
                            p.add(misc);
                ...
                case 3: //Backup - misc option indexed at 2 
                    ...
                    for (int y = 0; y<sList.getLength(); y++){
                        ...
                        Element temp = (Element) node;
                        ArrayList<Part> p = new ArrayList<Part>();
                        Misc initialS = new Sensor("Sensor", "0", 0.0, 0, "0");
                        p.add(initialS);
                        for (int z = 0; z <Integer.parseInt(temp.getElementsByTagName("qty").item(0).getTextContent()); z++){
                         misc = new Sensor("Sensor", temp.getAttribute("id"), Double.parseDouble(temp.getElementsByTagName("Cost").item(0).getTextContent()), Integer.parseInt(e.getAttribute("index")), temp.getElementsByTagName("sType").item(0).getTextContent());
                            p.add(misc);
